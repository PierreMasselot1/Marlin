...
#define MSU
  ...
  #define MSU_BOWDEN_TUBE_LENGTH 100 //length between MSU and the nozzle or from the MSU to the extruder gears (for direct drive setups)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 142.86 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -41, -11, -0.92 }
...
#define Z_PROBE_FEEDRATE_FAST (15*30)
